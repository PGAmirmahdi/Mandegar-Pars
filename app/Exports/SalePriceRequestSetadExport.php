...
class SalePriceRequestSetadExport implements FromCollection, WithHeadings, WithMapping
{
    public function collection()
    {
        return SalePriceRequest::where('type', 'setad_sale')->get();
    }
    public function map($salePriceRequest): array
    {
        return [
            ...
            $salePriceRequest->date . ' - ' . $salePriceRequest->hour,
