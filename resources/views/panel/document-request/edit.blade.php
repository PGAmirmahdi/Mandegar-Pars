...
@section('title', 'ویرایش درخواست مدارک')
...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('document_request.update', $document->id) }}" method="post">
                @method('PUT')
                @csrf
                ...
                <div class="form-row">
                    <div class="col-12 mb-3 table-responsive">
                        <table class="table table-striped table-bordered text-center">
                            ...
                            <tbody>
                            @php
                                // در صورت وجود cast در مدل نیازی به decode نیست
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                        ...
                        <textarea name="description" class="form-control" id="description" required>{{ old('description', $document->description) }}</textarea>
                        @error('description')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
