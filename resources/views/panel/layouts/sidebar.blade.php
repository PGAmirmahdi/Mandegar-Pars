...
<div class="navigation">
    ...
    <div class="navigation-menu-body">
        ...
        <ul id="navigationProducts"
            class="{{ active_sidebar(['debtors','debtors/create','debtors/{debtor}/edit','analyse/*','analyse','analyse/create','analyse/{analyse}/edit','search/analyse','foreign-customers','foreign-customers/create','foreign-customers/{foreign_customer}/edit','search/foreign-customers','customers','customers/create','customers/{customer}/edit','search/customers','productsModel','productsModel/create','productsModel/{productsModel}/edit','categories','categories/create','categories/{category}/edit','products','products/create','products/{product}/edit','search/products','printers','printers/create','printers/{printer}/edit','coupons','coupons/create','coupons/{coupon}/edit','prices-list', 'price-history','price-history-search','search/printers','artin-products','other-prices-list']) ? 'navigation-active' : '' }}">
            ...
            @endcan
            <li>
                <a class="{{ active_sidebar(['analyse','analyse/create','analyse/*','analyse/{analyse}/edit','search/analyse']) ? 'active' : '' }}"
                   href="{{ route('analyse.index') }}">مدیریت آنالیز کالا</a>
            </li>
            @can('prices-list')
                {{--                <li>--}}
        ...
        <ul id="navigationInvoices"
            ...
            @elseif(auth()->user()->role->name == 'ceo' || auth()->user()->role->name == 'admin' || auth()->user()->role->name == 'office-manager')
                <li>
                    <a class="{{ request()->query('type') === 'free_sale' || request()->is('sale_price_requests/{sale_price_request}/action') ? 'active' : '' }}"
                       href="{{ url('/panel/sale_price_requests?type=free_sale') }}">درخواست فروش آزاد</a>
                </li>
                <li>
                    <a class="{{ request()->query('type') === 'global_sale' || request()->is('sale_price_requests/{sale_price_request}/action') ? 'active' : '' }}"
                       href="{{ url('/panel/sale_price_requests?type=global_sale') }}">درخواست فروش سراسری</a>
                </li>
                <li>
                    <a class="{{ request()->query('type') === 'setad_sale' || request()->is('sale_price_requests/{sale_price_request}/action') ? 'active' : '' }}"
                       href="{{ url('/panel/sale_price_requests?type=setad_sale') }}">درخواست فروش ستاد</a>
                </li>
                <li>
                    <a class="{{ request()->query('type') === 'organization_sale' || request()->is('sale_price_requests/{sale_price_request}/action') ? 'active' : '' }}"
                       href="{{ url('/panel/sale_price_requests?type=organization_sale') }}">درخواست فروش سازمانی</a>
                </li>
                <li>
                    <a class="{{ request()->query('type') === 'industrial_sale' || request()->is('sale_price_requests/{sale_price_request}/action') ? 'active' : '' }}"
                       href="{{ url('/panel/sale_price_requests?type=industrial_sale') }}">درخواست فروش صنعتی</a>
                </li>
            @endif
