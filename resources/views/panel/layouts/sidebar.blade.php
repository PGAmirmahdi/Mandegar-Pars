...
<div class="navigation">
    <div class="navigation-icon-menu"
        ...
        <ul>
            ...
            @canany(['inventory-list','input-reports-list','output-reports-list'])
                <li class="{{ active_sidebar(['inventory/inout/{id}','inventorysnapshot','inventorysnapshot/search','inventory','inventory/create','inventory/{inventory}/edit','search/inventory','inventory-reports','inventory-reports/create','inventory-reports/{inventory_report}/edit','warehouses','warehouses/create','warehouses/{warehouse}/edit','search/inventory-reports','guarantees','guarantees/create','guarantees/{guarantee}/edit']) ? 'active' : '' }}"
    ...
    <div class="navigation-menu-body">
        ...
        <ul id="navigationProducts"
            ...
            @can('suppliers-list')
                <li>
                    <a class="{{ active_sidebar(['suppliers','suppliers/create','suppliers/{supplier}','suppliers/{supplier}/edit','search/suppliers']) ? 'active' : '' }}"
                       href="{{ route('suppliers.index') }}">بارگذاری تمامی تامین کنندگان</a>
                </li>
            @endcan
            @can('debtors-list')
                <li>
            ...
            <li>
                <a href="#Price" data-toggle="collapse" aria-expanded="false" aria-controls="Price">
                    <i class="ri-mail-line"></i>
                    <span> قیمت ها </span>
                    <i class="sub-menu-arrow ti-plus"></i>
                </a>
                <div id="Price">
                    <ul class="nav-second-level">
                        @can('prices-list')
                            ...
                            {{--                </li>--}}
                            <li class="{{ active_sidebar(['other-prices-list']) ? 'menuitem-active' : '' }}">
                                <a class="{{ active_sidebar(['other-prices-list']) ? 'active' : '' }}"
                                   href="{{ route('other-prices-list') }}"> قیمت کف بازار</a>
                            </li>
                        @endcan
                        <li class="{{ active_sidebar(['Mandegarprice','mandegar-price/search']) ? 'menuitem-active' : '' }}">
                            <a class="{{ active_sidebar(['Mandegarprice','mandegar-price/search']) ? 'active' : '' }}"
                               href="{{ route('Mandegarprice') }}">لیست قیمت ماندگار</a>
                        </li>
                        @can('price-history')
                            <li class="{{ active_sidebar(['price-history','price-history-search']) ? 'menuitem-active' : '' }}">
                                <a class="{{ active_sidebar(['price-history','price-history-search']) ? 'active' : '' }}"
                                   href="{{ route('price-history') }}">عملیات آرشیو قیمت ها</a>
                            </li>
                        @endcan
                        @can('exchange-list')
                            <li class="{{ active_sidebar(['exchange','exchange/details/{item}']) ? 'menuitem-active' : '' }}">
                        ...
                        @can('price-requests-list')
                            <li class="{{ active_sidebar(['price-requests','price-requests/create','price-requests/{price_request}/edit','price-requests/{price_request}']) ? 'menuitem-active' : '' }}">
        ...
        <ul id="navigationInvoices"
            ...
            @can('buy-orders-list')
                <li>
                    <a class="{{ active_sidebar(['buy-orders','buy-orders/create','buy-orders/{buy_order}/edit','buy-orders/{buy_order}','search/buy-orders','buy-orders/comments/{id}']) ? 'active' : '' }}"
            ...
            @php
                $roles = [
                    'internet_sale' => 'درخواست فروش اینترنتی',
        ...
        <ul id="navigationTickets"
            ...
            <li>
                <a class="{{ active_sidebar(['Ai','Ai/create','Ai/{Ai}','search/Ai']) ? 'active' : '' }}"
                   href="{{ route('Ai.index') }}">هوش مصنوعی ماندگار</a>
            </li>
            @can('tickets-list')
                <li>
        ...
        <ul id="navigationShops"
            ...
            <li>
                <a class="{{ active_sidebar(['off-site-products/{website}','off-site-product/{off_site_product}','off-site-product-create/{website}','off-site-products/{off_site_product}/edit']) && request()->website == 'ariaprint' ? 'active' : '' }}"
                   href="{{ route('off-site-products.index', 'ariaprint') }}">
                    <img src="{{ asset('assets/media/image/shop-logo/ariaprint.png') }}" style="width: 1.5rem">
                    <span class="ml-2">آریا پرینت</span>
                </a>
            </li>
        </ul>
        <ul id="navigationInventory"
            class="{{ active_sidebar(['inventory/inout/{id}','inventorysnapshot','inventorysnapshot/search','inventory','inventory/create','inventory/{inventory}/edit','search/inventory','inventory-reports','inventory-reports/create','inventory-reports/{inventory_report}/edit','warehouses','warehouses/create','warehouses/{warehouse}/edit','search/inventory-reports','guarantees','guarantees/create','guarantees/{guarantee}/edit']) ? 'navigation-active' : '' }}">
            ...
            @if(request()->warehouse_id)
                @can('inventory-list')
                    <li>
                        <a class="{{ active_sidebar(['inventory/inout/{id}','inventory','inventory/create','inventory/{inventory}/edit','search/inventory']) ? 'active' : '' }}"
