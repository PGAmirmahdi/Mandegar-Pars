...
ماندگارپارس
                `,
                template2: `با سلام
                 و احترام به منظور یادآوری، برای ثبت سفارش و استعلام قیمت
                 شما با ارسال نام و مشخصات پرینترتان به ما، می‌توانید از مشاوره دقیق‌تری بهره‌مند شوید.
                  ما به شما کمک می‌کنیم تا بهترین و مقرون‌به‌صرفه‌ترین کارتریج را برای شارژ دستگاهتان پیدا کنید و همچنین از قیمت‌ها مطلع شوید. ما علاوه بر ارسال رایگان از طریق پست، خدمات و پشتیبانی ویژه‌ای نیز به مشتریان ارائه می‌دهیم. تمامی محصولات ما دارای ضمانت و گارانتی معتبر هستند و در صورت بروز هرگونه مشکل، امکان مرجوع کردن آن‌ها به راحتی وجود دارد.
                 شماره‌های تماس:
                021-65425052
                5053
                5054
