...
<body>
<div class="No1">
    <img src="{{asset('assets/media/image/icon1.png')}}" width="100px" height="100px" alt="logo">
</div>
...
<img src="{{asset('assets/media/image/icon2.png')}}" alt="logo2">
<img src="{{asset('assets/media/image/icon3.png')}}" alt="logo3">
</body>
