...
@section('styles')
    ...
    <style>
        ...
        .message-item {
            background: linear-gradient(135deg, rgba(123, 31, 162, 0.8), rgba(207, 28, 238, 0.8)) !important;
        ...
        .outgoing-message {
            background: linear-gradient(135deg, rgba(140, 102, 155, 0.8), rgba(72, 10, 82, 0.8)) !important;
            backdrop-filter: blur(6.9px);
        }
            ...
            <div class="col-xl-12 mt-1 col-md-12 chat-body">
                ...
                <div class="px-3 border-bottom border-light" id="header-container">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('assets/media/image/avatar.jpg') }}" class="rounded-circle mr-2" height="65" alt="profile">
                        <div class="ms-3">
                    ...
                    <div id="tooltip-container" class="d-flex align-items-center">
                        ...
                        @endif
                        <div class="dropdown">
                            <button type="button" data-bs-toggle="dropdown" class="btn ml-2 btn btn-primary btn-floating" aria-expanded="true">
                                <i class="fa fa-cog"></i>
                            </button>
                ...
                <div class="chat-body-messages">
                    <div class="message-items">
                        @foreach($ticket->messages as $message)
                            ...
                            @else
                                <div id="message-{{ $message->id }}" class="message-item outgoing-message px-2 {{ $message->file ? 'message-item-media' : '' }}">
                                    @if($message->text)
                ...
                <div class="chat-body-footer">
                    ...
                    <form id="chatForm" action="{{ url(env('API_BASE_URL') . 'tickets/' . $ticket->id) }}" method="post" enctype="multipart/form-data" class="d-flex align-items-center px-3">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex ml-3">
                            ...
                            <div class="dropup">
                                <button type="button" data-bs-toggle="dropdown" class="btn btn-success btn-floating">
