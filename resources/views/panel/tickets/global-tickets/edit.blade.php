                ...
                <div class="px-3 border-bottom border-light" id="header-container">
                    ...
                    <div id="tooltip-container" class="d-flex align-items-center">
                        @if($ticket->status == 'closed')
                            <span class="badge bg-success mr-2">بسته شده</span>
                        @else
                            <span class="badge bg-warning mr-2">درحال بررسی</span>
                        @endif
                        <div class="dropdown">
                            <button type="button" data-toggle="dropdown"
                                    class="btn ml-2 btn btn-primary btn-floating" aria-expanded="false">
                                <i class="fa fa-cog"></i>
                            </button>
